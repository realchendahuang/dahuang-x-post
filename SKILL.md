...
X 上的爆帖是有行文规律的：Hook 怎么起、判断怎么前置、正文怎么排、什么形态该拆 Thread、外链放哪不丢 reach、收尾怎么不留 AI 腔。这个 skill 去研究一堆爆帖，把规律沉淀成可执行的改写规则，藏在 `references/` 里。

干的事：拿你手上的想法、观点、内容、项目、复盘，照这套规律改，产出符合 X 习性、更可能被停下来看、被转发、被回复的帖子。不靠天降灵感，靠沉淀过的规律。
